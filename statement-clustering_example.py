# -*- coding: utf-8 -*-
"""
Created on Mon Apr  8 23:32:07 2019
...
image = img_as_float(imread('E:\\User\\Desktop\\Khlamskaya_prog\\Coursera\\MashineLearning\\parrots.jpg'))
w, h, d = image.shape
...
def cluster(pixels, n_clusters=8):
    ...
    imsave('E:\\User\\Desktop\\Khlamskaya_prog\\Coursera\\MashineLearning\\__parrots_' + str(n_clusters) + '.jpg', mean_image)
    ...
    imsave('E:\\User\\Desktop\\Khlamskaya_prog\\Coursera\\MashineLearning\\__parrots_' + str(n_clusters) + '.jpg', median_image)
...
for n in range(1, 21):
    mean_image, median_image = cluster(pixels, 200)
